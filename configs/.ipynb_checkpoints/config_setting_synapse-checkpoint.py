...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': '/root/autodl-tmp/VM-UNet-main/pre_trained_weights/vmamba_small_e238_ema.pth',
    }
   ...
   # work_dir = '/root/autodl-tmp/VM-UNet-main/results/vmunet_synapse_Saturday_24_August_2024_12h_49m_06s'+ '/'
